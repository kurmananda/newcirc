...
const Footer = () => {
  return (
    <div>
    <footer
      class="hidden lg:flex flex-col items-center bg-[#023059] text-center text-surface">
      <div class="container ">
      ...
      <div class="b-10 p-4 text-center text-[#d9bd89] ">
        Copyright © 2025 STUDYCIRCUIT 
      </div>
    </footer>


  <footer
      class="flex lg:hidden flex-col items-center bg-[#023059] text-center text-surface ">
      <div class="container ">
        <div class=" flex justify-center space-x-4 p-6">          
